---
slug: /product-categories/wisnode/rak7204/at-command-manual/
title: RAK7204 WisNode Sense Home At Command Manual
description: For an easier experience with your LoRaWAN Module, a comprehensive list of commands for the LoRa P2P and LoRaWAN communication is provided. A serial communication interface is also presented for the two-way communication of the RAK7204.
...
4. ** at+set_config=device:gpio:`<pin_num>:<status>`  **
...
5. ** at+get_config=device:gpio:`<pin_num>` **
...
| --- | --- |
| data | The sending data format is in hexadecimal format. The possible values are between00-FF. The board will internally cast every two characters into a byte before sending it to the LoRa transceiver. The maximum length varies depending on the band frequency and DR (LoRaWAN standard). Refer toAppendix III. |
...
20. ** at+set_config=lora:work_mode:`<mode>` **
...
| mode | 0: LoRaWAN®1: LoRaP2P2: Test Mode. |
| --- | --- |
...
21. ** at+set_config=lora:dutycycle_enable:`<status>` **
...
22. ** at+set_config=lora:multicastenable:`<IsEnable>` **
...
23. ** at+set_config=lora:multicast_dev_addr:`<multicast_dev_addr>` **
...
24. ** at+set_config=lora:multicast_apps_key:`<multicast_apps_key>` **
...
25.  ** at+set_config=lora:multicast_nwks_key:`<multicast_nwks_key>` **
...
26. **set_config=lora:default_parameters **
...
| frequency | Frequency, the unit is HzThe default is 869525000Hz. |
| --- | --- |
| spreadfact | Spreading factorThe default is 12. |
| bandwidth | 0: 125KHz1: 250KHz2: 500KHzThe default is 0. |
| codeingrate | 1: 4/52: 4/63: 4/74: 4/8The default is 1. |
...
2. ** at+set_config=lorap2p:transfer_mode:`<mode>` **

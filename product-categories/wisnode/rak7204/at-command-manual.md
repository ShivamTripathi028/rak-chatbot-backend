...
| mode | 0: LoRaWAN® 1: LoRaP2P 2: Test Mode. |
| --- | --- |
...
| frequency | Frequency, the unit is Hz The default is 869525000Hz. |
| --- | --- |
| spreadfact | Spreading factor The default is 12. |
| bandwidth | 0: 125KHz 1: 250KHz 2: 500KHz The default is 0. |
| codeingrate | 1: 4/5 2: 4/6 3: 4/7 4: 4/8 The default is 1. |

---
slug: /product-categories/wisnode/solar-radiation-monitoring/overview/
title: Solar Radiation Monitoring Solution  
description: Browse all technical information and setup guide for the Radiation Monitoring Solution, which combines a Sensor Hub & RK200-03 Pyranometer for accurate solar activity monitoring.
keywords: 
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/solar-radiation-monitoring/quickstart/)
- [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisnode/solar-radiation-monitoring/lorawan-network-server-guide/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/solar-radiation-monitoring/datasheet/)
...
| 1 x Solar Radiation Sensor 1 x Sensor Probe IO | Sensor Probe IO + Solar Radiation Sensor |

...
- Refer to the <a href="https://docs.rakwireless.com/product-categories/wisnode/rak2560/io-datasheet/#overview" target="_blank">Probe IO Datasheet</a> for more details.

**Water Temperature Sensor Datasheet**

| PART/PARAMETER NAME | PARAMETER CONTENT |  |
| --- | --- | --- |
| Transmitter | DC Power Supply | 12 VDC- 24 VDC |
| Transmitter | Power Consumption | ≤ 0.15 W(12 VDC25° C) |

---
slug: /product-categories/wisnode/rak2270/overview/
title: RAK2270 Sticker Tracker
description: RAK2270 is a battery-powered LoRaWAN tracker with a label-like form factor. Simply tear, peel, and stick RAK2270 to any product to virtually track its location in real time by leveraging the location estimator functionality of the Helium network server.
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/rak2270/quickstart/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/rak2270/datasheet/)

---
slug: /product-categories/wisnode/barometric-pressure/overview/
title: Barometric Pressure Monitoring Sensor
description: The SensorHub barometric pressure monitoring solution includes the RAK1902 sensor in the Sensor Probe. It offers low power consumption and accurate data acquisition, making it suitable for measuring barometric pressure fluctuations.
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/barometric-pressure/quickstart/)
- [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisnode/barometric-pressure/lorawan-network-server-guide/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/barometric-pressure/datasheet/)

---
slug: /product-categories/wisnode/rak7201v2/overview/
title: RAK7201V2 WisNode Button 4K
description: The RAK7201V2 WisNode Button 4K is a remote wireless trigger device. It supports user-defined functions for each key and is based on the LoRaWAN 1.0.2 protocol.
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/rak7201v2/quickstart/)
- [AT Command Manual](https://docs.rakwireless.com/product-categories/wisnode/rak7201v2/at-command-manual/)
- [Firmware Upgrade Guide](https://docs.rakwireless.com/product-categories/wisnode/rak7201v2/firmware-upgrade-guide/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/rak7201v2/datasheet/)

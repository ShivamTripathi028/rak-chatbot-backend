---
slug: /product-categories/wisnode/rak2560/overview/
title: RAK2560 WisNode Sensor Hub
description: The RAK2560 WisNode Sensor Hub is a modular sensor ecosystem consisting of the main body and multiple pre-configured sensor probes. It has pluggable and interchangeable probes and supports third-party sensors integration.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/rak2560/quickstart/)
* [Payload Decoder](https://docs.rakwireless.com/product-categories/wisnode/rak2560/payload-decoder/)
* [Installation Guide](https://docs.rakwireless.com/product-categories/wisnode/rak2560/installation-guide/)
* [Hub Datasheet](https://docs.rakwireless.com/product-categories/wisnode/rak2560/hub-datasheet/)
* [Probe IO Datasheet](https://docs.rakwireless.com/product-categories/wisnode/rak2560/probe-io-datasheet/)

**Learn Guides**
- <a href="https://learn.rakwireless.com/hc/en-us/articles/30754813996055-how-to-connect-a-third-party-rs485-sensor-to-the-rak-sensor-hub?utm_source=docs&utm_medium=referral&utm_campaign=sensor-hub-rs485-guide" target="_blank">How to Connect a Third-Party RS485 Sensor to the RAK Sensor Hub</a>
- <a href="https://learn.rakwireless.com/hc/en-us/articles/31708802269079-how-to-connect-a-third-party-4-20-ma-analog-sensor-to-the-rak-sensor-hub?utm_source=docs&utm_medium=referral&utm_campaign=sensor-hub-analog-guide" target="_blank">How to Connect a Third-Party 4–20 mA Analog Sensor to the RAK Sensor Hub</a>
...
You can purchase the [RAK9154 Solar Battery in the RAKwireless store.](https://store.rakwireless.com/products/rak-battery-lite-solar-power-solution-rak9154?utm_source=RAK9154SolarBattery&utm_medium=Document&utm_campaign=BuyFromStore)
:::

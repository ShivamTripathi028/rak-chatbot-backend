...
:::tip NOTE
<sup>[1]</sup> - Custom or 3rd party sensors cannot be connected to the Probe IO Sensor Hub. If the desired sensor is not available in the [SensorHub Solutions](https://store.rakwireless.com/collections/sensorhub-solution?utm_source=RAK2560WisNodeSense&utm_medium=Document&utm_campaign=BuyFromStore), reach us at [support@rakwireless.com](mailto:support@rakwireless.com) and we will check the compatibility of your desired sensor. 
:::

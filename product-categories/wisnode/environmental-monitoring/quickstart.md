...
- [Sensor Hub Environmental Monitoring Solution](https://store.rakwireless.com/products/environmental-monitoring?variant=42510931329222?utm_source=solarpower&utm_medium=Document&utm_campaign=BuyFromStore)
...
1. Download and install the WisToolBox app on your smart mobile device. The WisToolBox app is available for download from the Apple [App Store](https://apps.apple.com/us/app/wistoolbox/id1575891664) and the Android [Google Play Store](https://play.google.com/store/apps/details?id=com.rak.wistoolbox&hl=en_US&gl=US).
...
Refer to the [Connect Gateway to TTN](https://docs.rakwireless.com/product-categories/wisnode/environmental-monitoring/lorawan-network-server-guide#connect-gateway-to-ttn) and [Connect Sensor Hub to TTN](https://docs.rakwireless.com/product-categories/wisnode/environmental-monitoring/lorawan-network-server-guide#connect-sensor-hub-to-ttn) sections for detailed instructions.
...
> **Image:** Connected temperature and humidity sensor

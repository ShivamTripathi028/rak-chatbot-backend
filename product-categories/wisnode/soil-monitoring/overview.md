---
slug: /product-categories/wisnode/soil-monitoring/overview/
title: Soil Moisture, Temperature, and Electrical Conductivity Solution
description: The Soil Moisture, Temperature, and Electrical Conductivity Solution consists of RAK Sensor Hub and RK520-02, designed for use in settings such as rice fields and greenhouse cultivation.
keywords:
- Sensor Hub
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/soil-monitoring/quickstart/)
- [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisnode/soil-monitoring/lorawan-network-server-guide/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/soil-monitoring/datasheet/)
...
| 1 x Soil Moisture, Temperature, and Electrical Conductivity Sensor1 x Sensor Probe IO | Sensor Probe IO + Soil Moisture, Temperature, and Electrical Conductivity Sensor |

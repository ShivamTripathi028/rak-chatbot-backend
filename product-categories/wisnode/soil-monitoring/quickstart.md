...
> **Image:** Soil Moisture, Temperature, and Electrical Conductivity Solutions Package Inclusion

### Hardware

- [Soil Moisture, Temperature, and Electrical Conductivity Solution](https://store.rakwireless.com/products/soil-monitoring?m=3&h=sensorhub-solution?m=3&h=sensor-hub&variant=42505216786630?utm_source=SoilMoisture&utm_medium=Document&utm_campaign=BuyFromStore)
...
> **Image:** Lock the device and the bracket
...
> **Image:** Sensor Probe IO and the Soil Moisture, Temperature, and Electrical Conductivity Sensor
...
> **Image:** Connect the power adapter
...
> **Image:** Connect the external power
...
> **Image:** Soil Moisture, Temperature and EC Sensor

2. Click the dropdown arrow to expand the details of the soil moisture, temperature, and EC sensor.

> **Image:** Details of the soil moisture, temperature and EC sensor

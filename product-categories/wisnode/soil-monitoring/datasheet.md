---
slug: /product-categories/wisnode/soil-monitoring/datasheet/
title: Soil Moisture, Temperature, and Electrical Conductivity Solution Datasheet
...
| Capacity        | The amount of electrical charge that a fully charged battery can store and subsequently provide to a device or system. 
 Unit: Ampere-hours (**Ah**)                                                                                                                                                                                    |
| Energy Capacity | The total amount of energy that a fully charged battery can deliver under specific conditions. 
 Unit: Watt-hours (**Wh**) or kilowatt-hours (**kWh**)                                                                                                                                                                                  |
...
| **Sensor Hub Load** | SP1110/P5              | SP1110/P5-N          | Pin1: P+ 
 ...
 IP67 
 Rated current 2A 
 Contact diameter 0.75mm *5 |
| **PV Input**        | SP1110/P2              | SP1110/P2-N          | Pin1: PV+ 
 Pin2: PV-                                                  | SP11 
 IP67 
 Rated current 1A 
 Contact diameter 1.0mm *2  |
...
| Moisture      | 0x03          | 0x0001           | 2           | 0x70        | 0.1   | %     | 0.1° %           | 0 ~ 100% (m<sup>3</sup>/m<sup>3</sup>) | ±2%(0 ~ 50%) 
 ±3%(51 ~ 100%) |

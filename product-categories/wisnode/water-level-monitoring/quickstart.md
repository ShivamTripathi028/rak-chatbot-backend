...
- [Sensor Hub Water Level Monitoring Solution](https://store.rakwireless.com/products/water-level-monitoring?variant=42505217638598)
...
> **Image:** Sensor Probe IO and Water Level Sensor
...
Refer to the [Connect Gateway to TTN](https://docs.rakwireless.com/product-categories/wisnode/water-level-monitoring/lorawan-network-server-guide/#connect-gateway-to-ttn) and [Connect Sensor Hub to TTN](/product-categories/wisnode/water-level-monitoring/lorawan-network-server-guide/#connect-sensor-hub-to-ttn) sections for detailed instructions.

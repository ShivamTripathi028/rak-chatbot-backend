---
slug: /product-categories/wisnode/water-level-monitoring/overview/
title: Water Level Monitoring Sensor
description: Sensor Hub Water Level Monitoring is widely used in applications for fluid monitoring, such as chemical industry, medicine, metallurgy, and hydrology exploration.
...
- [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisnode/water-level-monitoring/quickstart/)
- [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisnode/water-level-monitoring/lorawan-network-server-guide/)
- [Datasheet](https://docs.rakwireless.com/product-categories/wisnode/water-level-monitoring/datasheet/)
...
| 1 x Water Level Sensor 1 x Sensor Probe IO | Sensor Probe IO + Water Level Sensor |

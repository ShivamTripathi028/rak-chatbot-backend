---
slug: /product-categories/wisnode/rak7201/overview/
title: RAK7201 Product Overview
description: The RAK7201 WisNode Button 4K is a remote wireless trigger device. It supports user-defined functions for each key and is based on the LoRaWAN 1.0.2 protocol. Supported LoRaWAN bands are IN865, EU868, AU915, US915, KR920, and AS923.
...
- [Firmware Upgrade Guide](firmware-upgrade-guide.md) 
  
<!-- test only for firmware upgrade guide -->

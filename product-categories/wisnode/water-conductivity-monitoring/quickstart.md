...
> **Image:** Water Conductivity Solution Package Inclusion
...
Refer to the [Connect Gateway to TTN](https://docs.rakwireless.com/product-categories/wisnode/water-conductivity-monitoring/lorawan-network-server-guide#connect-gateway-to-ttn) and [Connect Sensor Hub to TTN](https://docs.rakwireless.com/product-categories/wisnode/water-conductivity-monitoring/lorawan-network-server-guide#connect-sensor-hub-to-ttn) sections for detailed instructions.
...
Supported frequency bands:  CN470, RU864, IN865, EU868, US915, AU915, KR920, AS923-1/2/3/4.
...
> **Image:** Water Conductivity sensor
...
> **Image:** Set the payload sensing interval

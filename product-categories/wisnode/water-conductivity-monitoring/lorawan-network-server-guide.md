...
1. Register an account and log in to the [TTNv3 website](https://eu1.cloud.thethings.network/console/).  If you already have a TTN account, you can log in using your **The Things ID** credentials.
...
- **Trust (CA Certificate)**: Click the [link](https://letsencrypt.org/certs/isrgrootx1.pem) to download.
...
This section will use the [RAK7268 V2 WisGate Edge Lite 2](https://store.rakwireless.com/products/rak7268-8-channel-indoor-lorawan-gateway?variant=42316475924678) as an example.

1. To access the gateway web management platform, refer to the [WisGateOS V2 user manual](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/wisgateos2/overview/#overview) for details.
...
- In this guide, name the dashboard ***SensorHub_Electrolyte***.
...
> **Image:** Successfully created visualization chart
...
> **Image:** Water Electrolyte data visualization

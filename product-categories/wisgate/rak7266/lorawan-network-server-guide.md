...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/web-user-interface-log-in.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/set-basics-station-mode.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/configure-network-mode-to-basics-station.svg"
  width="80%"
  caption="Configure Network Mode to Basics Station"
/>

5. Configure URI, Port, and Authentication Mode.

<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/configure-uri-port-and-authentication-mode.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/verify-operation.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/add-the-device-profile.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/add-the-service-profile.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/add-a-destination.svg"
  width="70%"
  caption="Add a Destination"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/wireless-device-configuration.svg"
  width="100%"
  caption="Wireless device configuration"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/joined-device.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/ttn-login.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/ttn-console-page.svg"
  width="100%"
  caption="Go to register a gateway"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/ttn-register-gateway.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/add-a-gateway-to-ttn.svg"
  width="100%"
  caption="Add a gateway to TTN"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/gateway-added.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/api-key-page.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/generate-api-key.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/copy-the-generated-key.svg"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/change-the-work-mode.svg"
  width="100%"
  caption="Change the working mode"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/expanded-basics-station-settings.svg"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/successful-connection.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/chirpstack-login-page.svg"
  width="50%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/chripstack-homepage.svg"
  width="100%"
  caption="Go to Gateways"
/>

4. To register one, click **Add gateway**.

<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/chirpstack-gateway-list.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/register-the-gateway.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/registered-gateway-list.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/set-packet-forwarder-mode.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/configure-packet.svg"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/registered-gateway.svg"
  width="100%"
  caption="Registered gateway"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/gateway-details.svg"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/mqtt-bridge.svg"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/configure-packet-forwarder-to-chirpstack.svg"
  width="80%"
  caption="Configure packet forwarder to ChirpStack"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/set-basics-station-mode.svg"
  width="100%"
  caption="Set Basics Station mode"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/configure-basics-station.svg"
  width="100%"
  caption="Configure Basics Station to ChirpStack"
/>
...
6. Configure ChirpStack Gateway Bridge for Basics Station.
  ...
  - Access the ChirpStack Server via SSH. Use an SSH terminal such as **PuTTY** to connect to your cloud instance. For guidance, refer to the <a href="https://learn.rakwireless.com/hc/en-us/articles/26743884863767-How-To-Use-Amazon-Web-Services-with-LoRaWAN/#accessing-instance-via-ssh" target="_blank">RAK Learn Site.</a>
      ...
      <RkImage
        src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/access-chirpstack.svg"
        width="60%"
  ...
  - In the file, find the gateway backend configuration paragraph and replace the type with `basic_station`.
      ...
      <RkImage
        src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/bridge-type.svg"
        width="100%"
  ...
  - Scroll down until you find the **Concentrator configuration** paragraph and uncomment the following text as shown below.
      ...
      <RkImage
        src="https://images.docs.rakwireless.com/wisgate/rak7266/lorawan-network-server-guide/bridge-backend.svg"
        width="100%"

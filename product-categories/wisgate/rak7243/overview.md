---
title: RAK7243 WisGate Developer D3
description: Learn more the full documentation for the RAK7243 WisGate Developer D3, a Raspberry Pi 3B+ LoRaWAN gateway with GPS, heat sink, and SX1301 chip for 8-channel LPWAN connectivity.
keywords:
    - RAK7243
    - LoRaWAN gateway
    - 8 channel gateway
    - LoRaWAN gateway for developer
    - LoRaWAN gateway with Raspberry Pi
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisgate/rak7243/quickstart/)
* [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisgate/rak7243/lorawan-network-server-guide/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wisgate/rak7243/datasheet/)

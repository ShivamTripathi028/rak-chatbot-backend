---
title: RAK7285 WisGate Edge Ultra LoRaWAN Network Server Guide
description: Comprehensive guide for configuring the RAK7285 WisGate Edge Ultra gateway with various LoRaWAN network servers, including built-in and third-party options.
...
1. Using your preferred Web browser, access the gateway. To access the gateway, see the [Quickstart guide](https://docs.rakwireless.com/product-categories/wisgate/rak7285/quickstart/).
...
1. Unable to see the web login:
   - Check that your Wi-Fi is connected to **RAK7285_XXXX or RAK7285C_XXXX**.
...
1. To configure the gateway, access it via the Web UI. To learn how to do that, refer to the [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisgate/rak7285/quickstart/).
...
For external ChirpStack, RAK provides instructions for installing the ChirpStack Network server on AWS cloud. You can refer to the [Learn Site](https://learn.rakwireless.com/hc/en-us/articles/26743884863767-How-To-Use-Amazon-Web-Services-with-LoRaWAN).
...
To access the ChirpStack configuration files, you need to access the instance. How to do this is explained in the [Learn Site](https://learn.rakwireless.com/hc/en-us/articles/26743884863767-How-To-Use-Amazon-Web-Services-with-LoRaWAN).
...
In this section, you will learn how to add RAK7285/RAK7285C WisGate Edge Ultra in **ThingPark**.

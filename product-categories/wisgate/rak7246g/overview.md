---
title: RAK7246G WisGate Developer D0
description: RAK7246G is a device consisting of a RAK2246 Pi HAT Concentrator module and a Raspberry Pi Zero W. It has a built-in GPS modules and a pre-installed radiator that guarantees stable thermal performance. Read the full documentation for more information.
keywords:
    - RAK7246G documentation
    - WisGate Developer D0 documentation
    - LPWAN Developer Gateway
    - Semtech SX1308 chip
    - Pi HAT LPWAN Concentrator
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisgate/rak7246g/quickstart/)
* [AWS Greengrass V2 Guide](aws-greengrass)
* [LoRaWAN Network Server Guide](https://docs.rakwireless.com/product-categories/wisgate/rak7246g/lorawan-network-server-guide/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wisgate/rak7246g/datasheet/)

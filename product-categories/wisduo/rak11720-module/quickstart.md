---
title: RAK11720 WisDuo LPWAN+BLE Module Quick Start Guide
...
slug: /product-categories/wisduo/rak11720-module/quickstart/
download: true
---
...
- [RAK11720 as a Stand-Alone Device Using RUI3](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#rak11720-as-a-stand-alone-device-using-rui3)
- [RAK11720 as a LoRa/LoRaWAN Modem via AT Command](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#rak11720-as-a-lora-lorawan-modem-via-at-command)
...
- <a href="https://store.rakwireless.com/products/rak11720-ambiq-apollo3-module-for-lorawan?utm_source=RAK11720&utm_medium=Document&utm_campaign=BuyFromStore" target="_blank">RAK11720 WisDuo LPWAN+BLE Module</a>
- Computer
...
- Add [RAK11720 as a supported board in Arduino IDE](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#-board-support-package-in-arduino-ide) by updating Board Manager URLs in **Preferences** settings of Arduino IDE with this JSON URL `https://raw.githubusercontent.com/RAKWireless/RAKwireless-Arduino-BSP-Index/main/package_rakwireless_com_rui_index.json`. After that, you can then add **RAKwireless RUI Apollo3 Boards** via Arduino board manager.
...
1. [Hardware Setup and Access to IO pins of RAK11720](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#hardware-setup)
2. [LoRaWAN OTAA and ABP Example with Arduino IDE](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#lorawan-example)
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_minimum.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_antenna_label.png"
  width="30%"
...
:::tip NOTE
- Detailed information about the RAK11720 BLE and LoRa IPEX MHF4 antenna can be found on the <a href="https://downloads.rakwireless.com/LoRa/WisBlock/Accessories/RAK_PCB_Antenna_for_LoRa_863-870_MHz_(RAKARB04)_Datasheet.pdf" target="_blank">863-870 MHz antenna datasheet</a> or the <a href="https://downloads.rakwireless.com/LoRa/WisBlock/Accessories/RAK_PCB_Antenna_for_LoRa_902-928_MHz_(RAKARB03)_Datasheet.pdf" target="_blank">902-928 MHz antenna datasheet</a>.

- If the RAK11720 is not an IPEX MHF4 variant, the connection to the antenna is done via the RF pins. RAKwireless offers <a href="https://store.rakwireless.com/products/antenna-rf-design-service-including-pcb-design-tuning-matching-and-rf-test" target="_blank">RF Antenna Design Service</a> for custom PCB designs.
:::

:::warning
- **Standard IPEX connector will not work on RAK11720!** The IPEX antenna connector of RAK11720 is a different variant called <a href="IPEX MHF4" target="_blank">https://www.i-pex.com/product/mhf-4</a>. This is specially designed for low-profile circuit boards with limited spaces.
...
Once the Arduino IDE has been successfully installed, configure the IDE to add the RAK11720 to its board selection by following these steps.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/installing-rak.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rui-nrf.png"
  width="90%"
...
1. After completing the steps for adding your RAK11720 to the Arduino IDE, try to run a simple program to test your setup. You need to add two LEDs to the bare minimum schematic of the RAK11720 module, as shown in **Figure 11**.

<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_led_breathing.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/select-port.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/arduino-console.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/led-example.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/verify-code.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/upload-code.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dev-prog.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-pins-io.png"
  width="55%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-analog.png"
  width="55%"
...
There are two UART peripherals available on the RAK11720. There are also different [Serial Operating Modes](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/serial-operating-modes/) possible in RUI3, namely Binary Mode, AT Mode, and Custom Mode.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-uart.png"
  width="30%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-i2c.png"
  width="30%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-spi.png"
  width="50%"
...
- [TheThingsNetwork Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#connecting-to-the-things-network-ttn) - How to login, register new accounts, and create new applications on TTN.
- [RAK11720 TTN OTAA Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ttn-otaa-device-registration) - How to add OTAA device on TTN and what AT commands to use on RAK11720 OTAA activation.
- [RAK11720 TTN ABP Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ttn-abp-device-registration) - How to add ABP device on TTN and what AT commands to use on RAK11720 ABP activation.
- [ChirpStack Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#connecting-with-ChirpStack) - How to create new applications on ChirpStack.
- [RAK11720 ChirpStack OTAA Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ChirpStack-otaa-device-registration) - How to add OTAA device to ChirpStack and what AT commands to use on RAK11720 OTAA activation.
- [RAK11720 ChirpStack ABP Guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ChirpStack-abp-device-registration) - How to add ABP device on ChirpStack and what AT commands to use on RAK11720 ABP activation.
...
1. The first step is to go to <a href="https://www.thethingsnetwork.org/" target="_blank">The Things Network</a> and sign up for an account, as shown in **Figure 27**. Then select a cluster as shown in **Figure 29**.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_new_5.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_new_7.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720_new_13.png"
  width="90%"
...
##### Upload OTAA LoRaWAN Example to RAK11720

After a successful registration of the RAK11720 device to the LoRaWAN Network Server, proceed with running the LoRaWAN OTAA demo application example.

:::tip NOTE

If you use RAK3172 as a LoRaWAN modem using AT commands instead of a stand-alone device, there is a dedicated section for the [OTAA AT Commands guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#otaa-configuration-for-ttn-via-wistoolbox-console) in the later portion of this document.
...
- The **device EUI (DEVEUI)** should match the device EUI registered in your network server. This is the same DEVEUI in the RAK11720 sticker if this is the one you used in the previous section [device registration in the network server](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ttn-otaa-device-registration). DEVEUI is **MSB**.
...
- Another important parameter to change is the **application key (APPKEY)**. This parameter should also be the same as the APPKEY in the network server you configured in the previous section [adding RAK11720 to the network server](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#ttn-otaa-device-registration) section. APPKEY is an MSB.
...
4. The last step is to upload the code by clicking the **Upload** icon. Take note that you should select the right board and port, as shown in the previous example [LED Blinking](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#compile-an-example-with-arduino-led-breathing).
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/abp_rak11720_new_3.png"
  width="80%"
  caption="Setting up your device"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/abp_rak11720_new_8.png"
  width="90%"
  caption="Setting up your device"
  zoomMode={true}
/>
...
##### Upload ABP LoRaWAN Example to RAK11720

After a successful registration of the RAK11720 module to the LoRaWAN Network Server as an ABP device, proceed with running the LoRaWAN ABP demo application example.

:::tip NOTE

If you use RAK3172 as a LoRaWAN modem using AT commands instead of a stand-alone device, there is a dedicated section for [ABP AT Commands guide](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#abp-configuration-for-ttn-via-wistoolbox-console) in the later portion of this document.
...
4. The last step is to upload the code by clicking the **Upload** icon. Note that you should select the right board and port, as shown in the previous example [LED Blinking](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#compile-an-example-with-arduino-led-breathing).
...
If you have your own ChirpStack installation, you can set up the device profile with `LoRaWAN MAC version 1.0.4` and `LoRaWAN Regional Parameters revision B` to make it compatible with RAK11720.
:::
...
5. After registering the RAK11720 in ChirpStack as an OTAA device, create a [custom firmware using the Arduino IDE for the RAK11720](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#uploading-otaa-lorawan-example-to-rak11720) or use [OTAA AT Commands](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#otaa-configuration-for-ttn-via-wistoolbox-console) with an external MCU host.
...
4. After registering the RAK11720 in ChirpStack as an ABP device, create a [custom firmware using Arduino IDE for RAK11720](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#uploading-abp-lorawan-example-to-rak11720) or use [ABP AT Commands](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#abp-configuration-for-ttn-via-wistoolbox-console) with external MCU host.

:::tip NOTE
More examples for the RAK11720 can be found in the <a href="https://github.com/RAKWireless/RUI3-Best-Practice" target="_blank">RUI3-Best-Practices</a> on Github.
:::
...
- LoRaWAN End-Device
- [LoRa P2P](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#lora-p2p-mode) - Point-to-point communication between two RAK11720 modules.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_9a.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_9b.png"
  width="90%"
  caption="Setting up Your Console"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_9c.png"
  width="90%"
  caption="Setting up Your Console"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_10.png"
  width="90%"
  caption="Setting up Your Console"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_11.png"
  width="90%"
  caption="Setting up Your Console"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/conwis_rak4630_new_12.png"
  width="90%"
  caption="Setting up Your Console"
  zoomMode={true}
/>
...
9.  With the end-device properly joined to the TTN, try to send some payload after a successful join. Send command format: **`AT+SEND=<port>:<payload>`**
...
Refer to the [P2P Mode](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/at-command-manual/) section of the AT command documentation to learn more about the definition of the parameters used.
...
All available commands can be found in the [AT Command Manual](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/at-command-manual/#general-commands) section of this document.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/available-serial-bluetooth.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/scanning-devices.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/connect-device.png"
  width="40%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/default-ble-id.png"
  width="70%"
...
1. [Using Arduino IDE](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#firmware-update-via-arduino-ide)
2. [Using Jlink](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#firmware-update-using-jlink)
3. [Recovery via UART](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/quickstart/#firmware-recovery)
...
You can upload the latest [RAK11720 HEX firmware](https://docs.rakwireless.com/product-categories/wisduo/rak11720-module/datasheet/#software) using Jlink. The RAK11720 must be powered up, and you have to connect the SWD lines of the RAK11720 (SWDIO, SWCLK, VDD, and GND) to the Jlink connector.

1. Download and install the <a href="https://www.segger.com/downloads/jlink/" target="_blank">Jlink software pack</a>, which includes the J-Flash software you need.
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-starting-jflash.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-jlink-select-chip.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-apollo3-select.png"
  width="70%"
  caption="Selecting the Apollo3 MCU"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-apollo3-confirm.png"
  width="70%"
  caption="Selecting the Apollo3 MCU"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-browse.png"
  width="70%"
  caption="Starting J-Flash"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-production-prog.png"
  width="70%"
  caption="Starting J-Flash"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-upload-1.png"
  width="70%"
  caption="Starting J-Flash"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/dfu-upload-2.png"
  width="70%"
  caption="Starting J-Flash"
  zoomMode={true}
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/rak11720-boot.png"
  width="20%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/recovery_board.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/recovery_bootload.png"
  width="90%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/recovery_reset_bootprocess.png"
  width="60%"
  caption="Indicator When to Reset the Module"
  zoomMode={true}
/>

4. When the initiation of uploading starts, release the reset pin connection to GND and wait until the process is finished.

<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak11720-module/quickstart/recovery_successful.png"
  width="60%"

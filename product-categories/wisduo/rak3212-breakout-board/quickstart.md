...
- [RAK3212 WisDuo LPWAN+BLE+WiFi Breakout Board](https://store.rakwireless.com/products/rak3212?utm_source=rak3212&utm_medium=Document&utm_campaign=BuyFromStore)
- Computer
- USB cable
...
:::tip NOTE
- Detailed information about the RAK3212 LoRa IPEX MHF4 antenna can be found on the [863-870 MHz antenna datasheet](https://downloads.rakwireless.com/LoRa/WisBlock/Accessories/RAK_PCB_Antenna_for_LoRa_863-870_MHz_(RAKARB04)_Datasheet.pdf) or the [902-928 MHz antenna datasheet.](https://downloads.rakwireless.com/LoRa/WisBlock/Accessories/RAK_PCB_Antenna_for_LoRa_902-928_MHz_(RAKARB03)_Datasheet.pdf)
:::

:::warning
- **Standard IPEX connector will not work on RAK3212.** The IPEX antenna connectors of RAK3212 are a different variant called [IPEX MHF-4.](https://www.i-pex.com/product/mhf-4) This is specially designed for low-profile circuit boards with limited spaces.
...
- Download the folder _**rakwireless**_ from our [GitHub repository.](https://github.com/RAKWireless/WisBlock/tree/master/examples/RAK3112/IDE-Patches/PlatformIO)

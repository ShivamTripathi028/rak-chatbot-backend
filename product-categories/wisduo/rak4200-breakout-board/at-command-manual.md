...
- <a href="https://docs.rakwireless.com/product-categories/wisduo/rak4200-breakout-board/quickstart/#connecting-to-the-things-network-ttn" target="_blank">TTN OTAA/ABP</a>
...
- <a href="https://docs.rakwireless.com/product-categories/wisduo/rak4200-breakout-board/quickstart#interfacing-with-rak4200-breakout-board" target="_blank">RAK Serial Port Tool Guide</a>
...
<table>
    ...
    <tr>
      <td> data </td>
      <td> The data to be sent can have a maximum length of **250 characters**, which is equivalent to 255 minus the length of the `at+...` command and the `\r\n` terminators.</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
      ...
      <td> 0: Low Voltage Level <br /> <br /> 1: High Voltage Level </td>
    </tr>
</table>

<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak4200-breakout-board/at-command/rak4200_bb_gpio_pin_v2.png"
  width="60%"
...
|-----------|-----------------------------------------------------------------------------------------------------------------------------------|
|  status   |  0: Low Voltage Level <br /> 1: High Voltage Level                                                                                |
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak4200-breakout-board/at-command/rak4200_bb_adc_pin_v2.png"
  width="60%"
...
<table>
    <tr>
      <td> port </td>
      <td> The sending port for LoRa ranges from **1 to 223**.</td>
    </tr>
    <tr>
      <td> data </td>
...
<table>
    <tr>
      <td> dr </td>
      <td> The LoRa data rate is region-specific. In most LoRa regions, data rates typically range from **0 to 5**. For detailed information, refer to the LoRaWAN 1.0.2 specification. </td>
    </tr>
</table>
...
The pin definition of the RAK4200 Breakout Board can be reviewed in the <a href="https://docs.rakwireless.com/product-categories/wisduo/rak4200-breakout-board/datasheet/#pin-definition" target="_blank">Pin Definition</a> section of the Datasheet.

Here is a summary of the pins on the RAK4200 Breakout Board:

:::tip NOTE
Not all pins of the RAK811 module are exposed on the RAK4200 Breakout board header connectors. Below are the pins available on the RAK811 Module that is on this Breakout board. For complete RAK811 module pinouts information, refer to the  <a href="https://docs.rakwireless.com/product-categories/wisduo/rak4200-breakout-board/datasheet/#pin-definition" target="_blank">datasheet</a>.
:::

---
title: Low Level Development Reference
description: Aside from the default RAK firmware on the RAK811 Module, you can create custom firmware using RUI (RAKwireless Unified Interface) or the actual SDK from the manufacturer of the microcontroller that is used inside the module.
keywords:
- wisduo
- RAK811
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduo/rak811-module/deep-development/memory-map.png"
  width="80%"

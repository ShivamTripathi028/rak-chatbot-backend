---
slug: /product-categories/wislink/rak5148/datasheet/
title: RAK5148 WisLink LPWAN 2.4 GHz Concentrator Module Datasheet
description: Provides comprehensive information about your RAK5146L WisLink LPWAN Concentrator to help you use it. This information includes technical specifications, characteristics, and requirements, and it also discusses the device components.
image: "https://images.docs.rakwireless.com/wislink-lora/rak5148/rak5148.png"
keywords:
  - datasheet
  - wislink
  - RAK5148
...
> **Image:** RAK5148 Board Overview

> **Image:** RAK5148 Antennas
...
|   29    |           GND            |     GND     |       |                   Ground                    |                                                                                                     |
|   30    |         SMB_CLK          |   I2C_SCL   |  IO   |                  HOST SCL                   | Connect to temperature sensor and GPS module ZOE-M8Q's SCL internally 
 Leave open if not in use |
|   31    |          PETn0           | PI_UART_TX  |  DI   |                HOST UART_TX                 |          Connect to GPS module ZOE-M8Q's UART_RX internally 
 Leave open if not in use           |
|   32    |         SMB_DATA         |   I2C_SDA   |  IO   |                  HOST SDA                   | Connect to temperature sensor and GPS module ZOE-M8Q's SDA internally 
 Leave open if not in use |
|   33    |          PETp0           | PI_UART_RX  |  DO   |                HOST UART_RX                 |          Connect to GPS module ZOE-M8Q's UART_TX internally 
 Leave open if not in use           |
|   34    |           GND            |     GND     |       |                   Ground                    |                                                                                                     |
|   35    |           GND            |     GND     |       |                   Ground                    |                                                                                                     |
...
> **Image:** RAK5148 Mechanical Dimension
...
> **Image:** RAK5148 Schematic Diagram
...
| Y - Additional features       | 1 - No additional features 
 2 - GPS       |
| Z - MCU RESET with or without | 1 - With MCU RESET 
 2 - Without MCU RESET |

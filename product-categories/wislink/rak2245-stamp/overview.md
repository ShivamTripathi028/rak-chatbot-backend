---
slug: /product-categories/wislink/rak2245-stamp/overview/
title: RAK2245 Stamp WisLink LPWAN Concentrator
description: RAK2245 Stamp is an ultra-compact module that has a built-in GPS chip. It comes with a mounted heat-sink that improves the thermal heat dissipation and overall performance of the device. The Stamp form factor feature enables easy integration into the system's mainboard.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wislink/rak2245-stamp/quickstart/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wislink/rak2245-stamp/datasheet/)

...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| GPIO0 | 1 | IO | General Purpose Input/Output | V OLmax =0.45 V V OHmin =1.35 V V ILmin =0.3 V V ILmax =0.6 V V IHmin =1.2 V V IHmax =2.0 V | 1.8 V power domain. Keep this open if unused. |  |  |  |  |
| GPIO1 | 2 | IO | General Purpose Input/Output | V OLmax =0.45 V V OHmin =1.35 V V ILmin =0.3 V V ILmax =0.6 V V IHmin =1.2 V V IHmax =2.0 V |  |  |  |  |  |
| ADC0 | 3 | AI | General Purpose Analog to Digital Converter | Voltage Range: 0.3 V to 1.8 V 15-bit resolution | Keep this open if unused. |  |  |  |  |
| ADC1 | 4 | AI | General Purpose Analog to Digital Converter | Voltage Range: 0.3 V to 1.8 V 15-bit resolution | Keep this open if unused. |  |  |  |  |
...
| Name | Pin | I/O | Description | DC Characteristics | Comments |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DB_G_RXD | 2 | di | Receive Data | V ILmin =0.3 V V ILmax =0.6 V V IHmin =1.2 V V IHmax =2.0 V | 1.8 V power domain. Keep this open if unused. |  |  |  |  |
| DBG_TXD | 3 | DO | Transmit Data | V OLmmin =0 V V OLmax =0.45 V V OHmin =1.35 V V OHmax =1.83 V | 1.8 V power domain. Keep this open if unused. |  |  |  |  |
| ADC0 | 3 | AI | General Purpose Analog to Digital Converter | Voltage Range: 0.3 V to 1.8 V 15-bit resolution | Keep this open if unused. |  |  |  |  |
| ADC1 | 4 | AI | General Purpose Analog to Digital Converter | Voltage Range: 0.3 V to 1.8 V 15-bit resolution | Keep this open if unused. |  |  |  |  |

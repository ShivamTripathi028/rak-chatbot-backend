---
slug: /product-categories/wislink/rak833/overview/
title: RAK833 WisLink LPWAN Concentrator
description: RAK833 comes in a compact size built with the mini-PCIe form factor that enables easy integration into an application board. It is compatible with the 3G/LTE modules of the mini-PCIe type. This module is for smart metering fixed networks.
image: "https://images.docs.rakwireless.com/wislink-lora/rak833/rak833.png"
keywords:
  - wislink
  - RAK833
...
* [Datasheet](https://docs.rakwireless.com/product-categories/wislink/rak833/datasheet/)
* **RAK833 USB/SPI + Raspberry Pi**
  * [Source Code Repository](https://github.com/RAKWireless/rak_common_for_gateway)
  * [RAK833 USB + Raspberry Pi Firmware](https://downloads.rakwireless.com/LoRa/RAK2247-Mini-PCIe/RPi-Firmware/RAK2247-USB_Latest_Firmware.zip)
  * [RAK833 SPI + Raspberry Pi Firmware](https://downloads.rakwireless.com/LoRa/RAK2247-Mini-PCIe/RPi-Firmware/RAK2247-SPI_Latest_Firmware.zip)
* **RAK833 USB + x86 PC**
  * [Source Code Repository](https://github.com/RAKWireless/rak_common_for_gateway)

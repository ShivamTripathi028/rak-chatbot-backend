---
slug: /product-categories/wislink/rak5166/datasheet/
title: RAK5166 WisLink LPWAN Concentrator Datasheet
description: Provides technical information about the RAK5166 WisLink LPWAN Concentrator for its usage. This information includes specifications, characteristics, requirements and the device components.
image: "https://images.docs.rakwireless.com/wislink-lora/rak5166/rak5166.png"
keywords:
  - datasheet
  - wislink
  - RAK5166
...
<RkImage
  src="https://images.docs.rakwireless.com/wislink-lora/rak5166/datasheet/rak5166_overview.png"
  width="50%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wislink-lora/rak5166/datasheet/rak5166-block-diagram.png"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wislink-lora/rak5166/datasheet/rak5166_pinout.png"
  width="80%"
...
<table>
    ...
    <tbody>
        <tr>
            <td>1</td><td>NC (CONFIG_3=GND)</td>
            <td> </td><td>No connection by default</td>
            <td>Reserved for CONFIG_3</td>
        </tr>
        <tr>
            <td>2</td><td>3.3&nbsp;V</td>
            <td>PI</td>
            <td>3.3&nbsp;V<sub>DC</sub> supply</td>
            <td> </td>
        </tr>
        <tr>
            <td>3</td>
        ...
        <tr>
            ...
            <td>USB_D+</td>
            <td>IO</td>
            <td>USB differential data (+)</td>
            <td>Require differential impedance of 90&nbsp;Ω</td>
        </tr>
        <tr>
            <td>8</td>
            <td>NC</td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td rowSpan="1" colSpan="1"> <b>KEY-B Notch</b> </td>
            <td></td>
        </tr>
        <tr>
            <td>20</td>
        ...
        <tr>
            <td>21</td>
            <td>NC (CONFIG_0=GND)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for CONFIG_0</td>
        </tr>
        <tr>
            <td>22</td>
            <td>NC</td>
        ...
        <tr>
            <td>30</td>
            <td>NC (Optional: MCU_RESET)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for MCU_RESET</td>
        </tr>
        <tr>
            <td>31</td>
            <td>NC</td>
        ...
        <tr>
            <td>40</td>
            <td>NC (Optional: I2C_SCL)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for connecting to GPS module ZOE-M8Q's I2C_SCL internally</td>
        </tr>
        <tr>
            <td>41</td>
            <td>NC</td>
        ...
        <tr>
            <td>42</td>
            <td>NC (Optional: I2C_SDA)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for connecting to GPS module ZOE-M8Q's I2C_SDA internally</td>
        </tr>
        <tr>
            <td>43</td>
            <td>NC</td>
        ...
        <tr>
            ...
            <td>GPS_RESET</td>
            <td>DI</td>
            <td>GSP module ZOE-M8Q reset input</td>
            <td>Active low, leave open if not in use</td>
        </tr>
        <tr>
            <td>47</td>
            <td>NC</td>
        ...
        <tr>
            <td>48</td>
            <td>NC (Optional: 1PPS)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for GPS module  Time pulse output</td>
        </tr>
        <tr>
            <td>49</td>
            <td>NC</td>
        ...
        <tr>
            ...
            <td>MCU_RESET</td>
            <td>DI</td>
            <td>RESET signal for MCU of RAK5166</td>
            <td>Active low</td>
        </tr>
        <tr>
            <td>51</td>
        ...
        <tr>
            ...
            <td>DO</td>
            <td>HOST_UART_RX</td>
            <td>Connect to GPS module ZOE-M8Q's UART_TX internally, leave open if not in use</td>
        </tr>
        <tr>
            <td>53</td>
            <td>NC</td>
        ...
        <tr>
            ...
            <td>DI</td>
            <td>HOST_UART_TX</td>
            <td>Connect to GPS module ZOE-M8Q's UART_RX internally, leave open if not in use</td>
        </tr>
        <tr>
            <td>55</td>
            <td>NC</td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td rowSpan="1" colSpan="1"> <b>KEY-M Notch</b> </td>
            <td></td>
        </tr>
        <tr>
            <td>67</td>
        ...
        <tr>
            <td>69</td>
            <td>NC (CONFIG_1=GND)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for CONFIG_1</td>
        </tr>
        <tr>
            <td>70</td>
            <td>3.3&nbsp;V</td>
        ...
        <tr>
            <td>75</td>
            <td>NC (CONFIG_2=GND)</td>
            <td> </td>
            <td>No connection by default</td>
            <td>Reserved for CONFIG_2</td>
        </tr>
    </tbody>
</table>
...
<RkImage
  src="https://images.docs.rakwireless.com/wislink-lora/rak5166/datasheet/rak5166_dimensions.png"
  width="25%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wislink-lora/rak5166/datasheet/rak5166-schematic-diagram.png"
  width="70%"

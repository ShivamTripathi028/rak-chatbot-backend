...
- [RAK5146 WisLink LPWAN Concentrator](https://store.rakwireless.com/products/wislink-concentrator-module-sx1303-rak5146-lorawan?utm_campaign=BuyFromStore&utm_medium=Document&utm_source=WisBlockRAK5146&variant=39677269409990)
- **Raspberry Pi 3/4** (RAK5146 bundle includes a Raspberry Pi 3 or 4)
- [RAK5146 Pi HAT](https://store.rakwireless.com/products/rak2287-pi-hat?utm_source=RAK5146PiHAT&utm_medium=Document&utm_campaign=BuyFromStore) (RAK5146 bundle includes a RAK5146 Pi HAT)
...
- Latest [RAK5146 Firmware](https://downloads.rakwireless.com/LoRa/RAK5146/Firmware/RAK5146_USB_Latest_Firmware.zip)
...
1. Download the latest firmware of **[RAK5146](https://downloads.rakwireless.com/LoRa/RAK5146/Firmware/RAK5146_USB_Latest_Firmware.zip)**, which is based on the Raspbian OS.
2. Use an image writing tool to install the firmware on the SD card. For this tutorial, **[Etcher](https://www.balena.io/etcher/)**, an open-source utility for burning image files, will be used.
...
- **The Things Network (TTN)**: If you choose TTN as the LoRa Server, you will see the following page. Visit the [LoRa Alliance Regional Parameters](https://lora-alliance.org/wp-content/uploads/2021/05/RP002-1.0.3-FINAL-1.pdf) for more information on your local TTN frequency plan. This will allow you to choose the correct plan.
...
:::warning
Make sure to input the correct Wi-Fi SSID and password. Otherwise, you will not be able to reconnect to the RAK5146 WisLink LPWAN Concentrator via SSH when it is in Wi-Fi AP Mode. If you find yourself in this situation, follow the procedure outlined in the [Connecting to a Network](https://docs.rakwireless.com/product-categories/wislink/rak5146/quickstart/#revert-to-wi-fi-ap-mode/) document, which is applicable for all Raspberry Pi-based gateways to restore Wi-Fi AP mode functionality.
:::

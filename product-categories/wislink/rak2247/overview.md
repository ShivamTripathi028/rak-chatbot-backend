---
slug: /product-categories/wislink/rak2247/overview/
title: RAK2247 WisLink LPWAN Concentrator
description: RAK2247 is functional to any embedded platform offering a mini-PCIe slot with an SPI or USB connection. This enables easy integration into routers and other networking equipment. Also, it offers maximum power transmission for a wider LoRaWAN network coverage.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wislink/rak2247/quickstart/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wislink/rak2247/datasheet/)
...
* **RAK2247 USB + x86 PC**
  * [Source Code Repository](https://github.com/RAKWireless/rak_common_for_gateway)
  * <a href="https://docs.rakwireless.com/product-categories/wislink/rak2247/quickstart/#rak2247--x86-linux-pc" target="_blank">Quick Start Guide</a>
...
:::tip NOTE
To address the chip shortage and not disrupt the operations of the customers and partners, the RAK2247 SPI is available with SX1308 core.  It can completely replace the RAK2247 with SX1301. The only difference is the operating temperature. For more information, check the <a href="https://docs.rakwireless.com/product-categories/wislink/rak2247/datasheet/#operating-conditions" target="_blank">RAK2247 Operating Conditions</a>.
:::
## Product Description

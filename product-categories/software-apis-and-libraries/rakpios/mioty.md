...
Create a new account in the [Loriot EU3 cluster](https://eu3.loriot.io/) site, the one with support for mioty. Then, log in.
...
1. Open a browser on your PC and visit [Loriot EU3 cluster](https://eu3.loriot.io/) site. You will be prompted with a login page.

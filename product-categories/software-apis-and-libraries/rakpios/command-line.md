---
title: RAKPiOS Command Line Utility
...
keywords:
  - rakpios
  - wisgate connect
sidebar_label: Command Line Utility 
---
...
<RkImage
  src="https://images.docs.rakwireless.com/software-apis-and-library/rakpios/rakpios/rakpios-cli/rakpios-cli-main-menu.png"
  width="70%"
...
RAKPiOS uses [**NetworkManager**](https://networkmanager.dev/) to manage network connections. For specific network requirements, you can manually create or modify connection files as shown in the [WisGate Connect Quick Start](https://docs.rakwireless.com/product-categories/wisgate/rak7391/quickstart/) section. However, for general and simple network connections, you can use `rakpios-cli` to manage Ethernet, WiFi, and LTE connections.

<RkImage
  src="https://images.docs.rakwireless.com/software-apis-and-library/rakpios/rakpios/rakpios-cli/rakpios-cli-network-main-menu.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/software-apis-and-library/rakpios/rakpios/rakpios-cli/rakpios-cli-deploy-services.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/software-apis-and-library/rakpios/rakpios/rakpios-cli/rakpios-cli-list-service.png"
  width="70%"
...
<RkImage
  src="https://images.docs.rakwireless.com/software-apis-and-library/rakpios/rakpios/rakpios-cli/rakpios-cli-service-details.png"
  width="70%"

---
title: WisgateOS OpenVPN Configuration
description: This guide shows how to configure OpenVPN, this guide also assumes that the user already has an AWS EC2 Instance with Ubuntu Server 18.04 LTS running on it.

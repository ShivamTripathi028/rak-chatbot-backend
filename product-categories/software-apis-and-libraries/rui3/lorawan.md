---
title: RUI3 LoRaWAN API | Key Management, Data Transmission, & Configuration
description: Master the RUI3 LoRaWAN API to manage keys, configure regional settings, send data, and set up multicast groups. Full documentation for IoT developers. 
...
keywords:
  ...
  - setup rui3 lorawan api
  - manage lorawan keys with rui3 api
  - rui3 multicast group command
  - lorawan data transmission with rui3 api
  - custom firmware using rui3 api
  - rui3 wireless communication api
  - lora api commands list
  - lora p2p api documentation
  - lorawan regional command setup
  - set device to lorawan mode
  - configure lorawan multicast group
  - regional configuration via api
  - lorawan api for iot network management
  - api for lorawan configuration
  - custom firmware for lorawan modules
tags:
  - rui3
  - lorawan api
date: 2022-07-04
...
This API configures the channel of the device by setting the hexadecimal channel mask. The complete table for mask value can be found on [AT+MASK section](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/at-command-manual/#at-mask)

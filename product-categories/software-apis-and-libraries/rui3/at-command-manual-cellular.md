...
## Overview
AT command manual for cellular is a supplementary document on the main [RUI3 AT command set](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/at-command-manual/). These set of AT commands only work on modules that have cellular capabilities.

### Devices that support RUI3 AT Commands Cellular

| RAK Modules                                        |
| -------------------------------------------------- |
| [RAK5010](https://docs.rakwireless.com/product-categories/wistrio/rak5010/overview/)     |
| [RAK5010-M](https://docs.rakwireless.com/product-categories/wistrio/rak5010-m/overview/) |
...
- [AT General Commands](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/at-command-manual/#general-commands)
- [AT Miscellaneous Commands](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/at-command-manual/#miscellaneous-at-command)

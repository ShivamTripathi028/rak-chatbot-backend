...
Set [custom payload](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/ble/#set-8) API. The URLs must be in [Eddystone](https://github.com/google/eddystone) format.
...
To send a beacon using RUI3 BLE API, you need to switch to [Beacon mode](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/ble/#blemode).

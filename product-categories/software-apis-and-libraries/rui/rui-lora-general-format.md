...
| **@param** | [DRIVER_MODE](#driver-mode.html) mode: lora peripheral work mode | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. |
...
| ---- | ---- | 
| **@return** | [RUI_RETURN_STATUS](/RUI/#rui-return-status.html) | 
| **@param** | [LORA_CLASS_MODE](/RUI/rui-lora-general-format/#lora-class-mode.html) class: Class A, Class B, or Class C. | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. | 
...
| ---- | ---- | 
| **@return** | [RUI_RETURN_STATUS](/RUI/#rui-return-status.html) | 
| **@param** | [LORA_JOIN_MODE](/RUI/rui-lora-general-format/#lora-join-mode.html) mode: OTAA or ABP | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. | 
...
| ---- | ---- | 
| **@return** | [RUI_RETURN_STATUS](/RUI/#rui-return-status.html) | 
| **@param** | [LORA_WORK_MODE](/RUI/rui-lora-general-format/#lora-work-mode.html) mode: LaRaWAN, P2P, or Test mode. | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. |
...
| ---- | ---- | 
| **@return** | [RUI_RETURN_STATUS](/RUI/#rui-return-status.html) | 
| **@param** | [RUI_LORA_AUTO_SEND_MODE](/RUI/rui-lora-general-format/#rui-lora-auto-send-mode.html) mode: lora auto send mode, refer to RUI. 
...
| ---- | ---- | 
| **@return** | [LORA_REGION](/RUI/rui-lora-general-format/#lora-region.html) value | 
...
| ---- | ---- | 
| **@return** | [RUI_RETURN_STATUS](/RUI/#rui-return-status.html) | 
| **@param** | [LORA_REGION](/RUI/rui-lora-general-format/#lora-region.html) region: the region of LoRaWAN. | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. | 
...
| **@param** | **bool IsPrint**: whether print parameters through serial 
 [RUI_LORA_STATUS_T](/RUI/rui-lora-general-format/#rui-lora-status.html) *status: the status about LoRa | 
| **@module** | RAK811, RAK4200, and RAK4600 core module. | 

...
| ---- | ---- | 
| **@return** | <a href="#rui-return-status.html" target="blank">RUI_RETURN_STATUS</a> | 
| **@param** | <a href="#driver-mode.html" target="blank">DRIVER_MODE</a> mode: the cellular module’s work mode | 
| **@module** | RAK8212-M and RAK5010 core module. | 

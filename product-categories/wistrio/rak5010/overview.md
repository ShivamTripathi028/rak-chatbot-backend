---
slug: /product-categories/wistrio/rak5010/overview/
title: RAK5010-BG95 WisTrio NB-IoT Tracker Pro
description: The RAK5010-BG95 is an advanced, highly flexible eMTC/NB-IoT/eGPRS tracker based on Quectel BG95-M3 (BG96 on the old model) LTE Cat M1&NB1, with an integrated with GPS, and BLE for outdoor and indoor applications. It also has built-in sensors such as temperature and humidity, motion, pressure, and light. The MCU running the board is a Nordic nRF52840 microcontroller.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wistrio/rak5010/quickstart/)
* [AT Command Manual](https://docs.rakwireless.com/product-categories/wistrio/rak5010/at-command-manual/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wistrio/rak5010/datasheet/)

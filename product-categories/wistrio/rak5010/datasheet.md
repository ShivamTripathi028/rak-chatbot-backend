---
slug: /product-categories/wistrio/rak5010/datasheet/
title: RAK5010-BG95 WisTrio NB-IoT Tracker Pro Datasheet
description: Provides comprehensive information about your RAK5010-BG95 WisTrio NB-IoT Tracker Pro to help you use it. This information includes technical specifications, characteristics, and requirements, and it also discusses the device components.
...
The **RAK5010-BG95 WisTrio NB-IoT Tracker Pro** is an advanced, highly flexible eMTC/NB-IoT/EGPRS tracker based on Quectel BG95-M3 (BG96 on the old model) LTE Cat M1&NB1, integrated with GPS, BLE, and a variety of sensors. The MCU running the board is a Nordic nRF52840 controller.
...
:::tip NOTE
**RAK5010-BG95** is an updated model of **RAK5010**. It uses the same circuit board and components except for the Quectel cellular modem used. The RAK5010-BG95 uses **BG95-M3** while the original RAK5010 uses **BG96**. It shares the same AT commands set as well so if you are using the AT command interface, the two versions are compatible.

If you are using a custom firmware (created with our RUI V2 or another IDE), you have to take into account that on the BG95-M3 you cannot use the cellular connection and the GNSS location acquisition at the same time. You have to stop the cellular connection before you can start the location acquisition!
:::
...
The overview presents the RAK5010-BG95 WisTrio top view and its block diagram that shows the core of the board.

#### Module Overview

**Figure 1** shows the top view and the interfaces of the RAK5010-BG95 NB-IoT tracker board.

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/top-view-of-the-board-with-interfaces.png"
  width="60%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/bottom-view-of-the-board-with-interfaces.png"
  width="60%"
  caption="Bottom View of the Board with Interfaces"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/board-dimensions.png"
  width="45%"
  caption="Board Dimensions"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/header-spacing.png"
  width="45%"
...
The block diagram in **Figure 5** shows the internal architecture and external interfaces of the RAK5010-BG95 board.

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/block-diagram.png"
  width="80%"
  caption="RAK5010-BG95 Block Diagram"
/>

### Hardware

The hardware specification is categorized into seven parts. It discusses the interfacing, pinouts, and their corresponding functions and diagrams. It also covers the standard parameters of the board in terms of Electrical, Mechanical, and Environmental of which the tabular data of the functionalities and the standard values are presented. Moreover, a thorough discussion of the RAK5010-BG95 specification is included in this section.
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/usb-connector-pinout.png"
  width="20%"
...
##### IO Connections between the BG95 and the nRF52840

The nRF52840 communicates with the BG95 primarily through the UART interface. There is, however, additional signaling between the two modules. This is for auto-monitoring of status indicators and control. The pin mapping is shown below:
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/turning-on-the-bg96-via-the-pwrkey.jpg"
  width="50%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/j-link-pinout.png"
  width="60%"
...
The logic level shift circuit on the RAK5010-BG95 board connects EXT_VREF to your extension board’s power and equalizes it to the logical level of the IO on your extension board.

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/typical-converter-circuitry.jpg"
  width="80%"
...
This section provides detailed specifications about the different modules present in the RAK5010-BG95 device.

##### 1. BG95-M3 Module

###### BG95-M3 Module Frequency Bands
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/ipex-onboard-connector-for-the-lte-antenna.jpg"
  width="25%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/pcb-lte-antenna-with-pigtail.png"
  width="50%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/ipex-onboard-connector-for-the-gps-antenna.jpg"
  width="25%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/circuit-diagram.png"
  width="50%"
  caption="iPEX onboard connector for the GPS antenna"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/circuit-diagram-2.png"
  width="50%"
  caption="iPEX onboard connector for the GPS antenna"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/gps-antenna.png"
  width="50%"
  caption="GPS Antenna"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/schematic-diagram-part-1.png"
  width="100%"
  caption="Schematic Diagram Part 1"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/schematic-diagram-part-2.png"
  width="100%"
  caption="Schematic Diagram Part 2"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/schematic-diagram-part-3.png"
  width="100%"
...
:::warning
The RAK5010, like any electronic equipment, is sensitive to electrostatic discharge (ESD). Improper handling can cause permanent damage to the module.
:::
...
The RAK5010-BG95 tracker board can be powered by a battery, connected to the P2. The nominal operational voltage of the battery should be within the range in the table:
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/battery-charging-via-solar-panel.jpg"
  width="60%"
...
- Oscilloscope
- RAK5010-BG95 WisTrio NB-IoT Tracker Pro

**Sending a Cellular Packet**

The RAK5010-BG95 WisTrio NB-IoT Tracker Pro takes **489.733&nbsp;ms** to send a Cellular packet which consumes **64.9&nbsp;mA** of current.

- **Sending Time**: 489.733&nbsp;ms
- **Current consumption**: 64.9&nbsp;mA

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/oscilloscope-screen-capture-of-lora-packet-sending.png"
  width="85%"
...
When in sleep mode, the RAK5010-BG95 WisTrio NB-IoT Tracker Pro consumes **20.5&nbsp;uA** of current.

- **Current consumption**: 20.5&nbsp;uA

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/oscilloscope-screen-capture-of-rak4600-in-sleep-mode.png"
  width="85%"
  caption="Oscilloscope Screen Capture of RAK5010-BG95 WisTrio Module in Sleep Mode"
/>
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/top-view-mechanical-dimension.jpg"
  width="75%"
  caption="Top View"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak5010/datasheet/bottom-view-mechanical-dimension.jpg"
  width="50%"
  caption="Bottom View"
/>
...
Download the latest firmware version of the RAK5010-BG95 WisTrio provided in the download link below.

:::warning
RAK5010-BG95 and RAK5010-M-BG95 have the same PCB, but their firmware is different and not interchangeable.
:::

| Model        | Version   | Source                                                                                              |
|--------------|-----------|-----------------------------------------------------------------------------------------------------|
| RAK5010-BG95 | V3.0.0.15 | [Download](https://downloads.rakwireless.com/Cellular/RAK5010/Firmware/RAK5010_Latest_Firmware.zip) |

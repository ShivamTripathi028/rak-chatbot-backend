---
slug: /product-categories/wistrio/rak815/overview/
title: RAK815 WisTrio LPWAN Tracker
description: RAK815 is a wireless remote solution that integrates both LoRaWAN 1.0.2 protocol and Bluetooth 5.0, supporting the LoRaWAN working mode and Bluetooth transparent transmission up to 300 meters. This board is in the standard Arduino form factor with a built-in GPS, acceleration, temperature, and humidity sensor.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wistrio/rak815/quickstart/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wistrio/rak815/datasheet/)

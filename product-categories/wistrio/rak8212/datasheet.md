...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/top-view.png"
  width="35%"
  caption="RAK8212 WisTrio iTracker Pro Top View"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/bottom-view.png"
  width="35%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/block-diagram.png"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/pin-definition.png"
  width="50%"
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------- |
| Frequency Band     | **Cat.M1/Cat.NB1**:<br />LTE FDD: B1/B2/B3/B4/B5/B8/B12/B13/B18/B19/B20/B26/B28<br />LTE TDD: B39 (for Cat.M1 only) |
|                    | **EGPRS**:<br />850/900/1800/1900&nbsp;MHz                                                                          |
| Data rate          | **Cat.M1**:<br />Max. 375&nbsp;Kbps (DL), Max. 375&nbsp;Kbps (UL)                                                   |
|                    | **Cat.NB1**:<br />Max. 32&nbsp;Kbps (DL), Max. 70&nbsp;Kbps (UL)                                                    |
|                    | **GPRS**:<br />Max. 85.6&nbsp;Kbps (DL), Max. 85.6&nbsp;Kbps (UL)                                                   |
|                    | **EDGE**:<br />Max. 236.8&nbsp;Kbps (DL), Max. 236.8&nbsp;Kbps (UL)                                                 |
...
| Item           | Specification                                                                                                                                 |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Frequency Band | Cat.M1/Cat.NB1: LTE FDD: B1/B2/B3/B4/B5/B8/B12/B13/B18/B19/B20/B26/B28 LTE TDD: B39 (for Cat.M1 only) <br />EGPRS: 850/900/1800/1900&nbsp;MHz |
...
<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/schematic-1.png"
  width="100%"
  caption="Schematic Diagram #1"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/schematic-2.png"
  width="100%"
  caption="Schematic Diagram #2"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/schematic-3.png"
  width="100%"
  caption="Schematic Diagram #3"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/schematic-4.png"
  width="100%"
  caption="Schematic Diagram #4"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wistrio/rak8212/datasheet/schematic-5.png"
  width="50%"

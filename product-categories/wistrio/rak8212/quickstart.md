...
- [Device Firmware Setup](quickstart#device-firmware-setup)
...
:::tip NOTE
For the complete list of AT Commands available for configuring your RAK8212 WisTrio iTracker Pro, kindly check the [AT Commands for iTracker Pro](https://docs.rakwireless.com/product-categories/wistrio/rak8212/at-command-manual/) section.
:::

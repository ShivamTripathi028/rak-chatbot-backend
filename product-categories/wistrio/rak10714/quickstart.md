---
slug: /product-categories/wistrio/rak10714/quickstart/
title: RAK10714 WisTrio LTE-M, NB-IoT, GSM Cellular, and LoRaWAN Development Board Quick Start Guide
description: Contains instructions and tutorials for installing and deploying your RAK10714 LTE-M, NB-IoT, GSM cellular, and LoRaWAN Development Board. Instructions are written in a detailed and step-by-step manner for an easier experience in setting up your device.
...
Before going through each step in the installation guide of the RAK10714 WisTrio LTE-M NB-IoT LoRaWAN Development Board, make sure to prepare the necessary items listed below:
...
- [Blues WisBlock Tracker](https://github.com/beegee-tokyo/Blues-WisBlock-Tracker)- the default firmware that is pre-flashed on the RAK10714 Solution.
...
The RAK10714 WisBlock Solution comes pre-flashed with location-tracking firmware that utilizes both cellular and LoRaWAN connectivity to transmit the acquired location to the cloud.
...
AT+JOIN=1,0,8,10
```
A detailed manual for the AT commands is in the [AT-Command-Manual](https://docs.rakwireless.com/product-categories/software-apis-and-libraries/rui3/at-command-manual/).
...
:::tip NOTE
RAK10714 software guide is focused on Cellular applications. If you are looking for its LoRa and LoRaWAN functionality,
...
There are several examples, utilizing the WisBlock RAK10714 you can find them in our GitHub repositories together with guides and tutorials:

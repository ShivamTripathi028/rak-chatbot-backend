...
<table>
      <tr>
            <td>accuracy</td>
          <td> 0: LPP format which is only 4 decimal digits accuracy <br />            1: 6 decimal digits accuracy  <br/>  The default is 0.</td>
        </tr>
</table>

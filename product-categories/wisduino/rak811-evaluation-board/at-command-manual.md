---
slug: /product-categories/wisduino/rak811-evaluation-board/datasheet/
title: RAK811 Evaluation Board AT Command Manual
description: For an easier experience with your LoRaWAN Module, a comprehensive list of commands for the LoRa P2P and LoRaWAN communication is provided. A serial communication interface is also presented for the two-way communication of the RAK811 Evaluation Board.
...
# RAK811 Evaluation Board AT Command Manual
...
- [TTN OTAA/ABP](https://docs.rakwireless.com/product-categories/wisduino/rak811-evaluation-board/quickstart/#lorawan-join-mode)
- [ChirpStack OTAA/ABP](https://docs.rakwireless.com/product-categories/wisduino/rak811-evaluation-board/quickstart/#lorawan-join-mode-2)
- [LoRa P2P](https://docs.rakwireless.com/product-categories/wisduino/rak811-evaluation-board/quickstart/#lora-p2p-mode)
...
| 81             | LoRa service is unknown. Unknown MAC command received by the node. Execute commands that are not supported in the current state, such as sending `at+join` command in P2P mode. |
...
| 88             | Service is closed by the server. Due to the limitation of the duty cycle, the server will send "SRV_MAC_DUTY_CYCLE_REQ" MAC command to close the service.                       |
...
This command is used to obtain the status of the device.
...
This command is used to change the baud rate of the UART port. There will be no reply after executing this configuration if a different baud rate was set. To make your UART serial communication work again, configure the UART baud rate setting of the Serial Port Tool based on the new baud rate.
...
<table>
    ...
    <tr>
      <td> baud_rate </td>
      <td> UART Baud rate：1200, 2400, 4800, 9600, 19200, 38400, 57600, 115200 </td>
    </tr>
</table>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisduino/rak811-evaluation-board/at-command/rak811-gpio-pins-02.png"
  width="60%"
...
<table>
    ...
    <tr>
      ...
      <td> Voltage，Unit: <b>mV</b> </td>
    </tr>
</table>

<RkImage
  src="https://images.docs.rakwireless.com/wisduino/rak811-evaluation-board/at-command/rak811-lowfreq-adc.png"
  width="61%"
  caption="ADC Pinout on Low-frequency modules for RAK811"
/>

<RkImage
  src="https://images.docs.rakwireless.com/wisduino/rak811-evaluation-board/at-command/rak811-highfre-adc.png"
  width="39%"
...
<table>
    ...
    <tr>
      <td> data </td>
      <td> The sending data format is in hexadecimal format. The possible values are between <b>00-FF</b>. The module will internally cast every two characters into a byte before sending it to the LoRa transceiver. The maximum length varies depending on the band frequency and DR (LoRaWAN standard). Refer to <a href="https://docs.rakwireless.com/product-categories/wisduino/rak811-evaluation-board/at-command-manual/#appendix-iii-maximum-transmission-load-by-region" >Appendix III</a>. </td>
    </tr>
</table>
...
<table>
    <tr>
      <td> region </td>
      <td> EU433, CN470, IN865, EU868, US915, AU915, KR920, AS923. The default is EU868. </td>
    </tr>
</table>
...
<table>
    <tr>
      <td>tx_power </td>
      <td> Refer to <a href="https://docs.rakwireless.com/product-categories/wisduino/rak811-evaluation-board/at-command-manual/#appendix-ii-tx-power-by-region" >Appendix II</a> for possible values of tx_power. The table of Appendix II is based on LoRaWAN 1.0.2 specification. LoRa transmit power level varies depending on frequency band.  <br/> If the resulting TX power is higher than the capability of LoRa Radio, the output power will be based on the max TX power of the LoRa Radio in the module. For RAK811 Evaluation Board, the max TX power is 20&nbsp;dBm. Take note of this when using regional bands with MaxEIRP higher than 20&nbsp;dBm like US915, AU915, and IN865 whose MaxEIRP is 30&nbsp;dBm.<br/>The default setting is 0. </td>
    </tr>
</table>
...
<table>
    <tr>
      <td> mode </td>
      <td>Work mode of LoRa<br />0: LoRaWAN<br />1: LoRa P2P  <br/> The default is LoRaWAN mode</td>
    </tr>
</table>
...
<table>
  ...
  <tr>
    <th></th>
    <th>UplinkDwellTime = 0</th>
    <th>UplinkDwellTime = 1</th>
    <th>DownlinkDwellTime = 0</th>
    <th>DownlinkDwellTime = 1</th>
  </tr>
  <tr>
    <td>0</td>
    <td>59</td>
...
The pin definition of the RAK811 Evaluation Board can be reviewed in the [Pin Definition](https://docs.rakwireless.com/product-categories/wisduo/rak811-module/datasheet/#pin-definition) section of the Datasheet.
...
The pinout mapping of the RAK811 module to the [WisDuino RAK811 Evaluation Board can be found on the Schematic](https://downloads.rakwireless.com/LoRa/WisNode/Hardware-Specification/WisNode-LoRa_Schematic.pdf)

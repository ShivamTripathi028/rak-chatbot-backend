---
slug: /product-categories/wisblock/rak1920/overview/
title: RAK1920 WisBlock Sensor Adapter Module
description: RAK1920 is a WisBlock Interface module, which extends the WisBlock system with an adapter board to connect Click Boards (MikroElektronika), QWICC (Sparkfun) based and Grove (Seeed) based sensors to WisBlock.

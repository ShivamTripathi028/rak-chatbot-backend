---
slug: /product-categories/wisblock/rak3372/at-command-manual/
title: RAK3372 WisBlock LPWAN Module AT Command Manual
description: For an easier experience with your LoRaWAN Module, a comprehensive list of commands for the LoRa P2P and LoRaWAN communication is provided. A serial communication interface is also presented for the two-way communication of the RAK3372.
...
The RAK3372 simplifies integrating LoRa technology into your projects by providing an easy-to-use Serial Port communication interface for sending AT commands. These commands allow you to configure the parameters required for LoRa P2P and LoRaWAN communication.

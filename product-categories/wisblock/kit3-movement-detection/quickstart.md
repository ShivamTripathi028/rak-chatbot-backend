---
slug: /product-categories/wisblock/kit3-movement-detection/quickstart/
title: WisBlock Movement Detection Kit Quick Start Guide
...
- If you already have an existing TTN account, you may proceed to the [OTAA Device Registration](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#otaa-device-registration) section.
...
- **RAK12013**: [Setting up RAK12013 Rada Sensor Dashboard Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-rak12013-radar-sensor-dashboard-using-thingspeak)
- **RAK12017**: [Setting up RAK12017 IR Proximity Sensor Dashboard Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-rak12017-ir-proximity-sensor-dashboard-using-thingspeak)
...
1. If you already have an existing **ThingSpeak account** and available channels to create, you may proceed to the next step. If you haven't yet created an account, go to the [Setting up Your Device Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-your-device-using-thingspeak) section to set up your **RAK12007 Ultrasonic Sensor**.
...
And for next steps, follow instruction used for [RAK12006](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#lorawan-code-for-rak12006) Module and use the above code instead.
...
1. If you already have an existing **ThingSpeak account** and available channels to create, you may proceed to the next step. If you haven't yet created an account, go to the [Setting up Your Device Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-your-device-using-thingspeak) section to set up your **RAK12013 Radar Sensor**.

2. Once done, refer to the [Setting up RAK12006 PIR Motion Sensor Dashboard Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-rak12006-pir-motion-sensor-dashboard-using-thingspeak) section and execute **Step 2** to **Step 7** since RAK12006 and RAK12017 have similar applications. The only difference between these two devices is that **RAK12013** reads radar data.
...
1. If you already have an existing TTN account, you may proceed to the next step. If you haven't yet created a TTN account, please refer to this [link](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#ttn-account-creation) for the steps.
...
1. If you already have **Arduino IDE** installed to your laptop or PC and added **RAK4631 board** into it, you may proceed to the next step. If you haven't yet installed the **Arduino IDE**, please refer to this [link](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#arduino-ide-installation-rak4631) for the steps.
...
1. If you already have your **ThingSpeak Account** and available channels to create, you may proceed to the next step. If you haven't yet created an account, go to the [Setting up Your Device Using ThingSpeak](https://docs.rakwireless.com/product-categories/wisblock/kit3-movement-detection/quickstart/#setting-up-your-device-using-thingspeak) section to set up your **RAK12017 IR Proximity Sensor**.

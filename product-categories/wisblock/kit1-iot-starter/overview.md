---
slug: /product-categories/wisblock/kit1-iot-starter/overview/
title: WisBlock IoT Starter Kit
description: The WisBlock IoT Starter Kit is a comprehensive kit that includes IoT communications modules (LoRaWAN, WiFi, BLE, LTE-M/NB-IoT) and multiple sensors (temperature/humidity, accelerometer, barometer, ambient light,  and GPS) to develop and prototype IoT applications.
image: "https://images.docs.rakwireless.com/wisblock/kits/1_iot_starter_kit_1.png"
keywords:
    - WisBlock Kit
    - IoT Starter Kit
    - WisBlock
...
* [Datasheet](https://docs.rakwireless.com/product-categories/wisblock/kit1-iot-starter/datasheet/)

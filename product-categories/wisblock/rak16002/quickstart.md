---
slug: /product-categories/wisblock/rak16002/quickstart/
title: RAK16002 WisBlock Coulomb Sensor Module Quick Start Guide
...
RAK16002 is a Coulomb sensor module based on LTC2941IDCB that features programmable high and low thresholds for the accumulated charge. If a threshold is exceeded, the device communicates an alert by setting a flag in the internal status register. It can measure the battery charge state in battery-powered IoT devices. For more information about the RAK16002, refer to the [Datasheet](https://docs.rakwireless.com/product-categories/wisblock/rak16002/datasheet/).

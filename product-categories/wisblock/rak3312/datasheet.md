...
The RAK3312 does not come with default firmware. You have to develop your application based on the Arduino IDE, using the Espressif BSP. Examples of how to use LoRa, LoRaWAN, BLE, and WiFi are available in the [GitHub repo.](https://github.com/RAKWireless/WisBlock/tree/master/examples/RAK3112)

For firmware development guide, refer to [RAK3312 Quick Start Guide](https://docs.rakwireless.com/product-categories/wisduo/rak3312/quickstart/#software-setup)

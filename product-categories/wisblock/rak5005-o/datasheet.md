...
There are six (6) slots on RAK5005-O WisBlock Base. The **CPU SLOT** is reserved for the WisBLock Core module, which has the main MCU. The **IO SLOT** is used for IO extension, for example, RS485 module, 4-20 mA/0-5 V module, Wireless modules. **SLOT A**, **SLOT B**, **SLOT C**, and **SLOT D** are used to connect with the I2C module, while **SLOT A** can be used for the GPS board too. Also, there are **2.54 mm pitch connectors** for [extension interface](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#j10-j11-j12-headers), such as **I2C**, **UART**, and **GPIO pins**.
...
- [WisBlock Core](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-core)
...
- [WisBlock Wireless](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-wireless)
...
- [WisBlock Sensor](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-sensor)
...
- [WisBlock Interface](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-interface)
...
- [WisBlock Display](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-display)
...
- [WisBlock Extra](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-extra)
...
- [WisBlock Storage](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-storage)

WisBlock Storage extends the memory capabilities of WisBlock solutions with different storage options like Flash, EEPROM, or SD-Card slots. The table below shows the [WisBlock Storage](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-storage) modules:
...
- [WisBlock Power](https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#wisblock-power)

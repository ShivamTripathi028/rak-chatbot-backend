---
slug: /product-categories/wisblock/rak5005-o/quickstart/
title: RAK5005-O WisBlock Base Board Quick Start Guide
...
# RAK5005-O WisBlock Base Board Quick Start Guide
...
- <a href="https://learn.rakwireless.com/hc/en-us/articles/26687371039383-How-To-Perform-Installation-of-Board-Support-Package-in-Arduino-IDE" target="_blank">Arduino IDE for RAK4631</a>
- <a href="https://docs.rakwireless.com/product-categories/wisblock/rak11200/quickstart/#arduino-ide-bsp-installation" target="_blank">Arduino IDE for RAK11200</a>
...
- <a href="https://learn.rakwireless.com/hc/en-us/articles/26687276346775-How-To-Perform-Installation-of-Board-Support-Package-in-PlatformIO" target="_blank">PlatformIO for RAK4631</a>
- <a href="https://docs.rakwireless.com/product-categories/wisblock/rak11200/quickstart/#installation-of-bsp-in-platformio" target="_blank">PlatformIO IDE for RAK11200</a>
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/datasheet/9.bus-data.png"
  width="80%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/datasheet/10.power-supply.png"
  width="100%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/1.arrows.png"
  width="50%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/2.alignment.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/3.header-to-socket.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/4.header-matched.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/5.buckle-the-head.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/6.uneven-forces.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/7.buckle-header-to-socket.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/8.not-parallel.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/9.detach-header.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/10.wrong-way-of-detaching.png"
  width="60%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/11.dont-rotate.png"
  width="60%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/12.dont-apply-force.png"
  width="55%"
...
A WisBlock Core module is designed to be installed on the CPU slot of the RAK5005-O Base Board. As shown in **Figure 16**, the location is properly marked by silkscreen. Follow carefully the procedure defined in <a href="#attaching-a-wisconnector">attaching a WisConnector</a> section in order to attach a Core module. Once attached, fix the module with one or more pieces of M1.2 x 3&nbsp;mm screws depending on the WisBlock Core.


<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/13.wisblock-core-silkscreen.png"
  width="75%"
...
To attach a WisBlock Sensor module, follow the procedure of the <a href="#attaching-a-wisconnector">attaching a WisConnector</a> section, carefully. Once attached, fasten the module with an M1.2 x 3&nbsp;mm screw.

<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/14.wisblock-sensor-silkscreen.png"
  width="75%"
...
A WisBlock IO module is designed to be installed on the IO slot of the RAK5005-O Base Board. There is a single IO slot in the RAK5005-O Base Board. As shown in **Figure 18**, the location is properly marked by silkscreen. Follow carefully the procedure of the section, <a href="#attaching-a-wisconnector">attaching a WisConnector</a>, to attach a WisBlock Sensor module. Once attached, fix the module with three pieces of M1.2 x 3&nbsp;mm screws.


<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/15.wisbloc-io-silkscreen.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/16.removing-screws.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/17.detaching-silkscreen.png"
  width="75%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/18.detaching-module.png"
  width="65%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/solar-connect.png"
  width="60%"
...
<RkImage
  src="https://images.docs.rakwireless.com/wisblock/rak5005-o/quickstart/solar-polarity.png"
  width="30%"
...
The full specification of the <a href="https://docs.rakwireless.com/product-categories/wisblock/rak5005-o/datasheet/#solar-panel-connector" target="_blank">Solar Panel Connection</a> can be found on the datasheet of the WisBlock Base.

### Software Setup

The WisBlock Core is designed to be interfaced with other WisBlock Modules like sensors, displays, and other interfaces. To make useful devices, you need to upload a source code to the WisBlock Core. Before you continue, you should have either an <a href="#software">Arduino BSP or PlatformIO already set up</a>.

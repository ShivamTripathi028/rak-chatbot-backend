---
slug: /product-categories/wisblock/rak4631-r/overview/
title: RAK4631-R WisBlock Core | Ultra-Low Power LoRaWAN & BLE Module
description: Unlock IoT potential with the RAK4631-R module featuring LoRaWAN, BLE, and ultra-low power. Ideal for smart devices, home automation, & industrial applications.
...
keywords:
  ...
  - rui3 based module
  - rak4631 with rui3 firmware
  - rak4631 vs rak4631-r
  - rak4631 pin configuration
  - lora wireless module
  - sx1262 lora transceiver
  - nrf52840 mcu
  - lorawan ble module
  - lorawan module for iot
  - nordic nrf52840 iot integration
  - low power lorawan module for iot
  - dual rf iot lora module
tags:
  - rak4631-r
  - wisblock
  - overview
...
* [RAK4631-R Quickstart Guide](https://docs.rakwireless.com/product-categories/wisblock/rak4631-r/quickstart/)
* [Example Applications](https://docs.rakwireless.com/product-categories/wisblock/rak4631-r/examples/)
* [AT Command Manual](https://docs.rakwireless.com/product-categories/wisblock/rak4631-r/at-command-manual/)
* [DFU - Device Firmware Upgrade](https://docs.rakwireless.com/product-categories/wisblock/rak4631-r/dfu/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wisblock/rak4631-r/datasheet/)

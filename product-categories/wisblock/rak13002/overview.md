---
slug: /product-categories/wisblock/rak13002/overview/
title: RAK13002 WisBlock IO Module
description: The RAK13002 is a WisBlock Core adaptor module that can be mounted to the IO slot of WisBlock Base board. This module exposed all WisBlock Core signals to male pin header, such as I2C, SPI, UART, GPIO, ADC, etc.
...
* [Sample Code: WisBlock IO Module](https://docs.rakwireless.com/product-categories/wisblock/rak13002/quickstart/#software-configuration-and-example)

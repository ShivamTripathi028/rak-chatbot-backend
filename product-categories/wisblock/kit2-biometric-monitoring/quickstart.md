---
slug: /product-categories/wisblock/kit2-biometric-monitoring/quickstart/
title: WisBlock Biometric Monitoring Kit Quick Start Guide
description: Contains extensive instructions and tutorials for installing and deploying your LoRaWAN project with the WisBlock IoT Education Kit - Medical Kit.
...
1. If you already have **Arduino IDE** installed on your laptop or PC and added **RAK4631 board** into it, you may proceed to the next step. If not, refer to the following section: [Arduino IDE Installation](https://docs.rakwireless.com/product-categories/wisblock/kit2-biometric-monitoring/#arduino-ide-installation-rak4631).

---
slug: /product-categories/wisblock/rak10702/overview/
title: RAK10702 WisBlock Indoor Comfort Node
description: RAK10702 Indoor Comfort Node is an easy-to-use air quality sensor kit. It includes all parts to measure CO2, particulate matter, volatile organic components, temperature, humidity, and light exposure. For the sensor data transmission, it supports LoRa P2P, LoRaWAN, and BLE communication.
...
* [Quick Start Guide](https://docs.rakwireless.com/product-categories/wisblock/rak10702/quickstart/)
* [AT Command Manual](https://docs.rakwireless.com/product-categories/wisblock/rak10702/at-command-manual/)
* [Assembly Guide](https://docs.rakwireless.com/product-categories/wisblock/rak10702/assembly-guide/)
* [Datasheet](https://docs.rakwireless.com/product-categories/wisblock/rak10702/datasheet/)

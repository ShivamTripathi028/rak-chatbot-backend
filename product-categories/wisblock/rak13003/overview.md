---
slug: /product-categories/wisblock/rak13003/overview/
title: RAK13003 WisBlock IO Expansion Module
description: The RAK13003 is an IO expansion module that can be mounted to IO slot of WisBlock Base board. It offers 16 bidirectional I/O ports by using MCP23017 IC from Microchip. The configuration of the module is via I2C interface and it supports both standard and fast I2C modes.

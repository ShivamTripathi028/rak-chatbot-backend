...
> **Image:** RAK1902 WisBlock Sensor Mounting
...
> **Image:** RAK1902 WisBlock Sensor connector pinout
...
| P<sub>AccRel</sub> | Relative Accuracy over Pressure    | P = 800 – 1100 hPa 
 T = 25 °C                                                            |      |          ±0.1           |      |      hPa       |
| P<sub>AccT</sub>   | Absolute Accuracy over Temperature | P<sub>op</sub> = 0 to 65 °C 
 after OPC  
 P<sub>op</sub> = 0 to 65 °C 
 no OPC |      | ±0.1 
  
  ±1 |      |      hPa       |
| P<sub>noise</sub>  | RMS Pressure Sensing Noise         | with embedded filtering                                                                                  |      |         0.0075          |      | hPa 
 RMS |
...
| ODR<sub>T</sub>  | Output Temperature Data Rate  |                     |      | 1 
 10 
 25 
 50 
 75 |      |   Hz   |
...
> **Image:** RAK1902 WisBlock Sensor Mechanic Drawing
...
> **Image:** RAK1902 WisBlock Sensor schematics
